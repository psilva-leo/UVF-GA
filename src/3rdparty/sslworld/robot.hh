...
#include "physics/pcylinder.hh"
#include "physics/pbox.hh"
...
public:    
    ...
    Robot(PWorld* world,PBall* ball,FieldConfig* _cfg,dReal x,dReal y,dReal z,dReal r,dReal g,dReal b,int rob_id,int wheeltexid,int dir);
    ~Robot();
    void step();
